...
namespace AW.AzureFunctionsAuth.Extensions
{
  public static class ServicesCollectionExtensions
  {
    public static void AddOidcApiAuthorization(this IServiceCollection services)
    {
      ...
      services.AddSingleton<IAuthorizationHandler, Handlers.HasPermissionHandler>();

      services.AddSingleton<IApiPermissionService, ClaimsApiPermissionService>();
    }
  }
}
